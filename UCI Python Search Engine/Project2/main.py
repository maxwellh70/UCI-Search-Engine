...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename="test_run/crawler_run.txt", filemode="a",format='%(asctime)s (%(name)s) %(levelname)s %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p',
                        level=logging.INFO)
